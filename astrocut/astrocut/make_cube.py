...
class CubeFactory():
    ...
    def _configure_cube(self, file_list, **extra_keywords):
        ...
        for i, ffi in enumerate(file_list):
            ...
            ffi_data = fits.open(ffi, mode='denywrite', memmap=True,ignore_missing_simple=True)
        ...
        with fits.open(self.file_list[0], mode='denywrite', memmap=True, ignore_missing_simple=True) as first_file:
        ...
        with fits.open(self.file_list[-1], mode='denywrite', memmap=True, ignore_missing_simple=True) as last_file:
    ...
    def _build_info_table(self):
        ...
        with fits.open(self.template_file, mode='denywrite', memmap=True, ignore_missing_simple=True) as ffi_data:
    ...
    def _write_block(self, cube_hdu, start_row=0, end_row=None, fill_info_table=False, verbose=False):
        ...
        for i, fle in enumerate(self.file_list):
            ...
            with fits.open(fle, mode='denywrite', memmap=True, ignore_missing_simple=True) as ffi_data:
    ...
    def _write_info_table(self):
        ...
        with fits.open(self.cube_file, mode='append', memmap=True, ignore_missing_simple=True) as cube_hdus:
    ...
    def make_cube(self, file_list, cube_file="img-cube.fits", sector=None, max_memory=50, verbose=True):
        ...
        # Fill the image cube
        with fits.open(self.cube_file, mode='update', memmap=True, ignore_missing_simple=True) as cube_hdu:
